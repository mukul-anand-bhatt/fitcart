...
const HealthSummary: React.FC<HealthSummaryProps> = ({ healthAnalysis, product }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-5 mb-6">
      <h3 className="text-lg font-semibold mb-4 text-gray-800">Health Analysis</h3>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex-1">
          <h4 className="text-sm font-medium text-gray-700 mb-2">Nutrient Exceedances</h4>
      ...
      <div className="mb-6">
        <h4 className="text-sm font-medium text-gray-700 mb-2">Health Summary</h4>
        <p className="text-sm text-gray-600 leading-relaxed">{healthAnalysis.summary}</p>
      </div>
      
      {healthAnalysis.max_daily_consumption && (
        <div>
          <h4 className="text-sm font-medium text-gray-700 mb-2">Recommended Daily Consumption</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-gray-600">
              {healthAnalysis.max_daily_consumption.by_calories && (
                <div className="flex items-start">
                  <svg className="w-4 h-4 text-blue-600 mt-0.5 mr-1.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
